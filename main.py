...
#resize and standardise our image to 500
...
#will reduce noise from our image and make it smooth
gray=cv2.bilateralFilter(gray,11,17,17)
cv2.imshow("Smoother Image",gray)
#cv2.waitKey(0)

#will find the edges of images
edged=cv2.Canny(gray,170,200)
cv2.imshow("Canny edge",edged)
#cv2.waitKey(0)

#will find the contours based on the images.
